...
step_install_tooling_libs_and_scripts() {
    ...
    local script
    for script in add-tenant.sh remove-tenant.sh upgrade-tenant.sh upgrade-all.sh list-tenants.sh tenant-cli.sh gh-rate-limit.sh certbot-renew-check.sh backup-tenants.sh restore-tenant.sh freeze-tenant.sh bebop-exit-handler.sh test-tenant-reaper.sh; do
